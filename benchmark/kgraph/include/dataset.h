...
public:
    ...
    kgraph::Matrix<float> load_base() const {
        return load_fvecs_as_matrix(base_file().c_str());
    }

    kgraph::Matrix<float> load_query() const {
        return load_fvecs_as_matrix(query_file().c_str());
    }
    ...
    kgraph::Matrix<float> load_explore_query() const {
        return load_fvecs_as_matrix(explore_query_file().c_str());
    }
