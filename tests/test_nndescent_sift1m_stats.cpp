...
int main(int argc, char** argv) {
    ...
    auto efanna_file   = R"(c:/Data/Feature/SIFT1M/efanna/sift_200nn.graph)"; // GQ 0.939619, avg degree 200, min_out 200, max_out 200, min_in 1, max_in 2622, zero in nodes 0
    auto top_list_file = R"(c:/Data/Feature/SIFT1M/SIFT1M/sift_base_top200_p0.998.ivecs)";
    compute_stats(efanna_file, 128, top_list_file);
